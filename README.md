...
Additionally for fun I created a word cloud with the ten thousand most occurring words in the song titles:
...
Using the Spotipy Python library I was able to access the Spotify API and pull song features and analysis data for 233k songs.
Since the bandwidth of the Spotify API is quite slow in relation to the amount of data, the application was running
